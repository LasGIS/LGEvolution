...
public interface AnimalBehaviour {
    ...
    /**
     * Уникальное имя животного. В простейшем случае название типа + номер.
     *
    ...
    /**
     * Относительный возраст животного в процентах от максимального.
     *
    ...
    /**
     * Вернуть ячейку, над которой в данный момент находится животное.
     *
    ...
    /**
     * Установить ранее сохраненные параметры животного.
     *
     * @param json ранее сохраненные параметры животного
     * @throws JSONException JSON Exception
     */
    void applyJsonObject(JSONObject json) throws JSONException;
}
