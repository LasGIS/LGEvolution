...
public class TokenParser {
    ...
    private static final String[] KEYWORD_NAMES = {
        "routine", "main", "function", "include", "import", "if", "else", "do", "for", "while", "until", "new", "break",
        "return"
    };
    ...
    public class Token {
         ...
         */
        public Token assertion(final TokenType tokenType) throws RoutineCompilerException {
            if (this.type != tokenType) {
                throw new RoutineCompilerException(this, "Expected TokenType == " + tokenType.name() + ".");
            }
            return this;
        }
         ...
         * @throws RoutineCompilerException .
         */
        public Token assertion(final TokenType tokenType, final String ... values) throws RoutineCompilerException {
            if (this.type == tokenType) {
            ...
            sbx.append("].");
            throw new RoutineCompilerException(this, sbx.toString());
        }
        ...
        if (token.type != null) {
            switch (token.type) {
                ...
                case delimit: {
                    ...
                    } else if (str.length() >= 2 && "/*".equals(str.substring(0, 2))) {
                        token.end = end;
